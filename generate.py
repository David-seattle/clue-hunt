...
PAGES = [
    ...
    },
    {
        ...
        "gate": {
            ...
            "unlocked_hint": "Where treasure belongs.",
            "unlocked_hint2": "Look underneath.",
            "success": "A smart pirate ye are! Now ye got one job to do.",
            "unlocked": "You follow a map to X. Thar she be buried.",
        },
    ...
    {
        "slug": "bd0cc471",
        "hide_at": "Under the treasure chest",
        "mark": "VI",
    ...
    },
    {
        ...
        "gate": {
            ...
            "hint2": "Song lyrics.",
            "unlocked_hint": "Empty o' ale, full o' secrets.",
            "unlocked_hint2": "No boost needed for you.",
            "success": "One step closer&hellip;",
            "unlocked": "The grandest grog vessel aboard sits far from thievin' hands.",
        },
    ...
    },
    {
        ...
        "riddle": "The case of a man, reliving an ordinary day.",
        "hint": "Grab the Kleenex and the popcorn.",
        "hint2": "A DVD case.",
    ...
    },
    {
        ...
        "riddle": "The crow's nest is often untouched.",
        "hint": "A swarthy mate like you needs no chair.",
        "hint2": "Watch out for the dust.",
